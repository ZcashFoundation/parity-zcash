...
use crate::v1::types::{BlockRef, H256};
...
pub trait BlockChain {
    ...
    #[rpc(name = "getblock")]
    fn block(&self, _: BlockRef, _: Option<u8>) -> Result<GetBlockResponse, Error>;
    ...
    #[rpc(name = "gettxout")]
    fn transaction_out(&self, _: H256, _: u32, _: Option<bool>) -> Result<GetTxOutResponse, Error>;
