...
use ser::serialize;
use zebra_chain::{IndexedTransaction, OutPoint};
...
mod tests {
    ...
    fn bloom_filter_matches_transaction_by_hash() {
        let tx1: IndexedTransaction = zebra_test_data::TransactionBuilder::with_output(10).into();
        let tx2: IndexedTransaction = zebra_test_data::TransactionBuilder::with_output(20).into();
    ...
    fn bloom_filter_data_works_on_address() {
        use zebra_message::{deserialize_payload, types};
