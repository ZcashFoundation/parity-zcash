...
impl Input {
    fn new(size: usize) -> Self {
        Input {
            bits: bitvec::BitVec::with_capacity(size),
        }
    }
    ...
    fn smoky_pghr() {
        let js = JoinSplit {
            descriptions: vec![JoinSplitDescription {
                ...
                random_seed: hash2(
                    "b1624b703774e138c706ba394698fd33c58424bb1a8d22be0d7bc8fe58d369e8",
                ),
                macs: [
            ...
            pubkey: hash2("cdb0469ee67776480be090cad2c7adc0bf59551ef6f1ac3119e5c29ab3b82dd9")
                .into(),
    ...
    fn smoky_groth() {
        let js = JoinSplit {
            descriptions: vec![JoinSplitDescription {
                ...
                ephemeral_key: [0u8; 32], // not used
                random_seed: hash2(
                    "eab222220caeff4a484a7b88fa322392dffb795b2738b467db22f4ac50866e4e",
                ),
                macs: [
            ...
            pubkey: hash2("99a01b54019222b7d1b4ec8b321313b0120fceb63b3915eb2a8434d816c1f8f7")
                .into(),
            sig: [0u8; 64].into(), // not used
        };
