...
mod tests {
    ...
    fn difficulty() {
        ...
        assert!(compare_f64(
            Compact::new(0x1b0404cb).to_f64(limit),
            16307.42094
        ));
        ...
        assert!(compare_f64(
            Compact::new(0x1f111111).to_f64(limit),
            0.000001
        ));
        assert!(compare_f64(
            Compact::new(0x1ef88f6f).to_f64(limit),
            0.000016
        ));
        assert!(compare_f64(
            Compact::new(0x1df88f6f).to_f64(limit),
            0.004023
        ));
        assert!(compare_f64(
            Compact::new(0x1cf88f6f).to_f64(limit),
            1.029916
        ));
        assert!(compare_f64(
            Compact::new(0x12345678).to_f64(limit),
